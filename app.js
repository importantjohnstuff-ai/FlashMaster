document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadFileList() {
        try {
            ...
            const fileNames = ['PEC1.json', 'PEC2.json', 'PEC3.json', 'PEC4.json', 'PEC5.json', 'PEC6.json', 'ESAS1.json', 'ESAS2.json', 'ESAS3.json', 'ESAS4.json', 'ESAS5.json', 'ESAS6.json', 'MATH1.json', 'PROF1.json'];
